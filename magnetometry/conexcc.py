...
class ConexCC:
    ...
    def wait_for_ready_silent(self, timeout=60):
        #print('waiting for ready state...', end='')
        count = 0
        sleep_interval = 0.2
        last_count = (1 / sleep_interval) * timeout
...
if __name__ == '__main__': 
    ...
    conex_cc_1 = ConexCC(com_port='com6', velocity=0.4)
    conex_cc_2 = ConexCC(com_port='com5', velocity=0.4)
    conex_cc_1.driver.RS(DEV,'')
    ...
    # ConexCC.dump_possible_states()
	# conex_cc = ConexCC(com_port='com6', velocity=0.4)
	# conex_cc.driver.RS(DEV,'')
	# conex_cc.read_controller_state()
