...
//**************************************************************
//For bitmapping of single points it is only necessary to turn off 
//certian channels, whilst, applying the gate signal to the row and
//column corresponding to the selected point.

//Read in row & column corresponding to desired point
